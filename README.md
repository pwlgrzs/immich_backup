...
1. Message [@BotFather](https://t.me/BotFather) on Telegram and run `/newbot` to create a bot â€” copy the token it provides
...
Notifications are optional â€” if either variable is missing from `.env`, the backup runs normally and silently skips the Telegram step.
